...
val reins_IAT_or_RET_MASK_p :
  X86_PARSER.X86_BASE_PARSER.coq_parser

val reins_IAT_JMP_p :
  X86_PARSER.X86_BASE_PARSER.coq_parser

val reinsjmp_IAT_or_RET_p :
  X86_PARSER.X86_BASE_PARSER.coq_parser

val reinsjmp_IAT_or_RET_mask :
  X86_PARSER.X86_BASE_PARSER.coq_parser
...
val reinsjmp_IAT_or_RET_dfa : X86_PARSER.X86_BASE_PARSER.coq_DFA
...
val extract_disp : int8 list -> int32 option
...
val extract_indirect_jmp :
  X86_PARSER.X86_BASE_PARSER.coq_parser -> int8 list -> address option option

val is_call : X86_PARSER.X86_BASE_PARSER.coq_parser -> int8 list -> bool
...
val checkIATAddresses : iATBounds -> Int32Set.t -> bool

val checkCallAlignment : Int32Set.t -> bool

val checkExecSectionLowMemory : int32 -> int32 -> bool

val checkExecSection :
  X86_PARSER.X86_BASE_PARSER.coq_DFA -> X86_PARSER.X86_BASE_PARSER.coq_DFA ->
  X86_PARSER.X86_BASE_PARSER.coq_DFA -> X86_PARSER.X86_BASE_PARSER.coq_DFA ->
  X86_PARSER.X86_BASE_PARSER.coq_parser -> iATBounds ->
  ((int32 * int32) * int8 list list) -> bool * Int32Set.t
...
val checkProgram' : int8 list list -> bool * Int32Set.t
